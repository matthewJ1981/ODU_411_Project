...
class About:
    def __init__(self, mainClass, backEnd):
        print("      Entering Parent - about screen - /parent/frontEnd/dashboard/pages/about.py")
        ...
        def displayAbout():     
            ...
            self.messageEntry = Text(self.aboutInformationEntriesFrame, height = 10, width=60)
